...
## Introduction
This project repository is the final project for the **.NET Technology course**. This project is a simulation of a Library Management application to demonstrate the application of C# OOP, database connection, and system architecture. 
We use this README.md file instead of a traditional Software Design Document.

## Group Members & Roles
- Vu Ngoc An Thuan (**Leader**, System Analysis, Backend Development)
- Tran Nguyen Hau (Frontend Development, UI/UX Design)
- Vu Huy Minh (Backend Development, Database Design)
- Dang Le Hoang Danh (Document Preparation, Testing)

## 1. Description
This document describes version 1.0 for the Library Management System. It is divided into the following sections:
- In section 2, an overview of the system’s requirements will be provided, including a list of system users, use cases, a use case diagram, and activity diagrams which describe the most important use case scenarios.
